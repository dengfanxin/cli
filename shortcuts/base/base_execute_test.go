...
func TestBaseFieldExecuteCRUD(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		factory, stdout, reg := newExecuteFactory(t)
		registerTokenStub(reg)
		registerDeleteAuthCodeValidationStub(reg, "app_x")
		reg.Register(&httpmock.Stub{
			Method: "DELETE",
			URL:    "/open-apis/base/v3/bases/app_x/tables/tbl_x/fields/fld_x",
			Body:   map[string]interface{}{"code": 0, "data": map[string]interface{}{}},
		})
		if err := runShortcut(t, BaseFieldDelete, []string{"+field-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--field-id", "fld_x", "--auth-code", "larkauth_v1_test", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
...
func TestBaseTableExecuteReadAndDelete(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		...
		if err := runShortcut(t, BaseTableDelete, []string{"+table-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--auth-code", "larkauth_v1_test", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
...
func TestBaseRecordExecuteReadCreateDelete(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		...
		if err := runShortcut(t, BaseRecordDelete, []string{"+record-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--record-id", "rec_1", "--auth-code", "larkauth_v1_test", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
...
func TestBaseViewExecuteReadCreateDeleteAndFilter(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		...
		if err := runShortcut(t, BaseViewDelete, []string{"+view-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--view-id", "vew_1", "--auth-code", "larkauth_v1_test", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
